  ...
  <form @submit="onSubmit" class="grid grid-cols-1 sm:grid-cols-2 bg-white px-5 gap-5">
    <div class="first-col">
      ...
      <div class="mb-4">
        ...
        <CustomInput v-bind="titleAttrs" v-model="title" :error="errors.title" />
      </div>

      <div class="mb-4">
        <label for="slug" class="form-label">Slug</label>
        <CustomInput v-bind="slugAttrs" v-model="slug" :error="errors.slug" />
      </div>
...
.size-btn {
  @apply bg-blue-100 p-2 rounded w-14 mr-2 flex-1;
}
</style>
